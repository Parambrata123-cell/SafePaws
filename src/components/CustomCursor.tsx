...
export const CustomCursor: React.FC = () => {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Check explicit data-cursor attribute if present
      ...
      if (textEl) {
        // If text is inside a button or link, button/link takes precedence (already handled above)
        setMode('text');
        setContextLabel('');
        return;
      }
